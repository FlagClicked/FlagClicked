...
export default {
  ...
  computed: {
    renderedContent() {
      ...
      let _document = parser.parseFromString(`<html><body>${marked(this.content)}</body></html>`, 'text/html')
      ...
      let results = Array.from(_document.querySelectorAll('code.lang-scratchblocks'))
