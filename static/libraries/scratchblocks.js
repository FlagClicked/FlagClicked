...
var scratchblocks = (function () {
  ...
  function c(e, t) {
    ...
    Object.keys(t.commands).forEach(function (e) {
      ...
      Object.keys(t.renamedBlocks || {}).forEach(function (e) {
        ...
        if (!x[s]) throw new Error("Unknown ID: " + s);
        var o = x[s],
          i = n(e);
        z.blocksByHash[i] = o;
      }),
  ...
  function p(e, t) {
    if (!x[e]) throw new Error("Unknown ID: " + e);
    x[e].specialCase = t;
  }
  function h(e, t, s) {
  ...
  function y(e, t, s) {
    ...
    if (d) {
      ...
      (e.language = o),
        ...
        ("ring" === u.shape ? "reporter" === e.shape : "stack" === e.shape) &&
          (e.shape = u.shape),
        ...
        for (m.s(); !(f = m.n()).done; ) {
          ...
          if (b(t, k)) {
            ...
            for (
              var w,
                A = t.splice(
                  k.definePrefix.length,
                  t.length - k.defineSuffix.length
                ),
                S = 0;
              S < A.length;
              S++
            ) {
              if (((w = A[S]), w.isInput && w.isBoolean))
                w = y(
                  {
                    shape: "boolean",
                    argument: "boolean",
                ...
                (w.isReporter || w.isBoolean) &&
                  w.info.categoryIsDefault &&
                  ((w.info.category = "custom-arg"),
    ...
    ye(e, n), e.hasLoopArrow && t.push(new ie("loopArrow"));
    var v = new ne(e, t);
    return (u && ke.test(u.spec) && v.translate(o, !0), "+" === e.diff)
      ? new ce(v)
      : ((v.diff = e.diff), v);
  }
  function b(e, t) {
  ...
  function k(e, t) {
    ...
    function n() {
      for (var t = O + 1; t < e.length; t++) if (" " !== e[t]) return e[t];
    }
    function r(e, s) {
    ...
    function l(e) {
      for (var t, s = []; L && "\n" !== L; ) {
        ...
        switch (L) {
          ...
          case "@":
            o();
            for (var c = ""; L && /[a-zA-Z]/.test(L); ) (c += L), o();
            "cloud" === c
              ? s.push(new oe("\u2601"))
              : s.push(
          ...
          case "\\":
            o();
          case ":":
            if (":" === L && ":" === a()) return s.push(b(e)), s;
          default:
            t || s.push((t = new oe(""))), (t.value += L), o();
        }
      }
      return s;
    }
    function p() {
      ...
      return (
        ...
        ue.test(e)
          ? new ae("color", e)
          : !t && / v$/.test(e)
          ? c("dropdown", e.slice(0, e.length - 2))
          : new ae("string", e)
      );
    }
    function h(e) {
      ...
      if ((L && "\n" === L && ((S = !0), o()), 0 !== t.length)) {
        if (1 === t.length) {
          var s = t[0];
          if (s.isBlock && (s.isReporter || s.isBoolean || s.isRing)) return s;
        }
        return r("stack", t);
      }
    }
    function d() {
      ...
      var e = l(")");
      if ((L && ")" === L && o(), 0 === e.length)) return new ae("number", "");
      ...
      if (p.info && "ring" === p.info.shape) {
        ...
        h && h.isInput && "number" === h.shape && "" === h.value
          ? (p.children[0] = new ae("reporter"))
          : ((h && h.isScript && h.isEmpty) ||
              (h && h.isBlock && !h.children.length)) &&
            (p.children[0] = new ae("stack"));
      }
      return p;
    }
    function u() {
    ...
    function g() {
      ...
      return (
        ...
        "}" === L && o(),
        S ? new le(s) : (m(1 >= s.length), s.length ? s[0] : r("stack", []))
      );
    }
    function f() {
      var e = L;
  ...
  var R = [
    ...
    B = [
      ...
      if (x[s.id]) throw new Error("Duplicate ID: " + s.id);
      return (x[s.id] = s), (D[t] = s);
    }),
    F = {
      "@greenFlag": "\u2691",
      "@turnRight": "\u21BB",
    ...
    p("CONTROL_STOP", function (e, s, o) {
      ...
      if (i.isInput) {
        ...
        if (-1 < o.osis.indexOf(a))
          return t({}, x.CONTROL_STOP, { shape: "stack" });
      }
    });
  var G = {
      loadLanguages: l,
  ...
  (Q.prototype.isBlock = !0),
    (Q.prototype.stringify = function (e) {
      ...
      if (s && i && this.info.selector) {
        ...
        if (r) return j.test(r) && t && (r = r.replace(j, t.stringify())), r;
      }
      var c = e || "";
      return (
      ...
      if (o) {
        ...
        if (g) {
          ...
          var y = _(u).parts,
            ...
            k = 0,
            w = b.map(function (e) {
              return (k = E(k, e)), m[e - 1];
            }),
            A = m.slice(k);
          (this.children = f.parts
            .map(function (e) {
              var e = e.trim();
              if (e) {
                var t = U(e);
  ...
  var se = {
    ...
    yt = xe.commentRect,
    bt = xe.commentLine,
    kt = xe.strikethroughLine,
    wt = function (e, t) {
      (this.el = xe.el(
        "filter",
        O(t, { id: e, x0: "-50%", y0: "-50%", width: "200%", height: "200%" })
      )),
        (this.highestId = 0);
    };
  (wt.prototype.fe = function (e, t, s) {
    var o = e.toLowerCase().replace(/gaussian|osite/, ""),
      i = [o, "-", ++this.highestId].join("");
    return (
      this.el.appendChild(
        xe.withChildren(xe.el("fe" + e, O(t, { result: i })), s || [])
      ),
      i
    );
  }),
    (wt.prototype.comp = function (e, t, s, o) {
      return this.fe("Composite", O(o, { operator: e, in: t, in2: s }));
    }),
    (wt.prototype.subtract = function (e, t) {
      return this.comp("arithmetic", e, t, { k2: 1, k3: -1 });
    }),
    (wt.prototype.offset = function (e, t, s) {
      return this.fe("Offset", { in: s, dx: e, dy: t });
    }),
    (wt.prototype.flood = function (e, t, s) {
      return this.fe("Flood", { in: s, "flood-color": e, "flood-opacity": t });
    }),
    (wt.prototype.blur = function (e, t) {
      return this.fe("GaussianBlur", { in: t, stdDeviation: [e, e].join(" ") });
    }),
    (wt.prototype.colorMatrix = function (e, t) {
    ...
    (wt.prototype.merge = function (e) {
      this.fe(
        "Merge",
        {},
        e.map(function (e) {
          return xe.el("feMergeNode", { in: e });
        })
      );
    });
  var At = wt,
      ...
      var t = (e.exports = {
        ...
        makeIcons: function () {
          return [
            ...
            xe.el("path", { d: "M0 0L4 4L0 8Z", fill: "#111", id: "addInput" }),
            xe.el("path", { d: "M4 0L4 8L0 4Z", fill: "#111", id: "delInput" }),
            xe.setProps(
              xe.group([
                xe.el("path", {
        ...
        makeStyle: function () {
          var e = xe.el("style");
          return e.appendChild(xe.cdata(t.cssContent)), e;
        },
        ...
        darkRect: function (e, t, s, o) {
          return xe.setProps(
            xe.group([
              xe.setProps(o, { class: ["sb-" + s, "sb-darker"].join(" ") }),
            ]),
            { width: e, height: t }
          );
        },
  ...
  (Ut.prototype.isLabel = !0),
    (Ut.prototype.draw = function () {
      return this.el;
    }),
    Object.defineProperty(Ut.prototype, "width", {
      get: function () {
    ...
    (Ut.metricsCache = {}),
    (Ut.toMeasure = []),
    (Ut.prototype.measure = function () {
      var e = this.value,
        t = "sb-" + this.cls;
      this.el = xe.text(0, 10, e, { class: "sb-label " + t });
      var s = Ut.metricsCache[t];
      if (
        (s || (s = Ut.metricsCache[t] = Object.create(null)),
        ...
        var o = /comment-label/.test(this.cls)
          ...
          ? "normal 9px " + Ht
          : "bold 10px " + Ht;
        this.metrics = s[e] = Ut.measure(e, o);
      }
    }),
    (Ut.measure = function (e, t) {
      var s = Ut.measuring;
      s.font = t;
  ...
  var Kt = function (e) {
    t(this, e), e.label && (this.label = $t(e.label)), (this.x = 0);
  };
  (Kt.prototype.measure = function () {
    ...
    (Kt.prototype.draw = function (e) {
      ...
      var o = (this.height = this.isRound || this.isColor ? 13 : 14),
        i = Kt.shapes[this.shape](s, o);
      this.isColor
        ? xe.setProps(i, { fill: this.value })
        : this.isDarker &&
          ((i = Vt(s, o, e.info.category, i)),
          e.info.color && xe.setProps(i, { fill: e.info.color }));
      var a = xe.group([
        xe.setProps(i, {
  ...
  var Wt = function (e) {
    switch (
      (t(this, e),
      (this.children = e.children.map($t)),
      (this.comment = this.comment ? $t(this.comment) : null),
      this.info.category)
    ) {
      case "music":
  ...
  (Wt.prototype.isBlock = !0),
    ...
    (Wt.prototype.drawSelf = function (e, t, s) {
      if (1 < s.length)
        return xe.mouthRect(e, t, this.isFinal, s, {
          class: ["sb-" + this.info.category, "sb-bevel"].join(" "),
        });
      if ("outline" === this.info.shape)
        return xe.setProps(xe.stackRect(e, t), { class: "sb-outline" });
      if (this.isRing) {
        var o = this.children[0];
        if (o && (o.isStack || o.isBlock || o.isScript)) {
          var i = o.isScript ? "stack" : o.isStack ? o.shape : o.info.shape;
          return xe.ringRect(e, t, o.y, o.width, o.height, i, {
            class: ["sb-" + this.info.category, "sb-bevel"].join(" "),
          });
        }
      }
      var a = Wt.shapes[this.info.shape];
      if (!a) throw new Error("no shape func: " + this.info.shape);
      return a(e, t, {
        class: ["sb-" + this.info.category, "sb-bevel"].join(" "),
      });
    }),
    (Wt.prototype.minDistance = function (e) {
    ...
    (Wt.prototype.draw = function () {
      ...
      var t = "define-hat" === this.info.shape,
        s = this.children,
        o = Wt.padding[this.info.shape] || Wt.padding[null],
        a = o[0],
        n = o[1],
        r = o[2],
        c = 0,
      ...
      for (var g, p = [], b = 0; b < w.length; b++) {
        ...
        for (var k, R = g.height, h = 0; h < g.children.length; h++) {
          ...
          if (
            ...
            (p.push(xe.move(n + k.x, 0 | (g.y + c), k.el)), "+" === k.diff)
          ) {
      ...
      return (
        p.splice(0, 0, C),
        this.info.color && xe.setProps(C, { fill: this.info.color }),
        xe.group(p)
      );
    });
  var Xt = function (e) {
    t(this, e), (this.label = $t(e.label)), (this.width = null);
  };
  (Xt.prototype.isComment = !0),
    (Xt.lineLength = 12),
    (Xt.prototype.height = 20),
    ...
    (Xt.prototype.draw = function () {
      ...
      return (
        ...
        xe.group([
          xe.commentLine(this.hasBlock ? Xt.lineLength : 0, 6),
          xe.commentRect(this.width, this.height, { class: "sb-comment" }),
          xe.move(8, 4, e),
        ])
      );
    });
  var qt = function (e) {
    t(this, e),
      (this.child = $t(e.child)),
      (this.width = null),
      (this.height = null),
      (this.y = 0);
  };
  (qt.prototype.isGlow = !0),
    (qt.prototype.measure = function () {
      this.child.measure();
    }),
    (qt.prototype.drawSelf = function () {
      var e,
        t = this.child,
        s = this.width,
        o = this.height - 1;
      ...
      return xe.setProps(e, { class: "sb-diff sb-diff-ins" });
    }),
  ...
  var Zt = function (e) {
    t(this, e), (this.blocks = e.blocks.map($t)), (this.y = 0);
  };
  (Zt.prototype.isScript = !0),
    ...
    (Zt.prototype.draw = function (e) {
      ...
      for (var o = 0; o < this.blocks.length; o++) {
        var a = this.blocks[o],
          n = e ? 0 : 2,
          r = a.draw();
        t.push(xe.move(n, s, r)), (this.width = E(this.width, a.width));
        var c = a.diff;
        if ("-" === c) {
          var l = a.width,
        ...
        if (h) {
          var d = a.firstLine,
            u = a.innerWidth + 2 + Xt.lineLength,
  ...
  (Qt.prototype.measure = function () {
    ...
    (Qt.prototype.render = function () {
      ...
      return (
        n.appendChild(
          (this.defs = xe.withChildren(
            xe.el("defs"),
            [
              _t("bevelFilter", !1),
              _t("inputBevelFilter", !0),
              jt("inputDarkFilter"),
            ].concat(Gt())
          ))
        ),
    ...
    (Qt.prototype.exportSVGString = function () {
    ...
    (Qt.prototype.exportPNG = function (e, t) {
  ...
  var Jt = function (e) {
    ...
    es = { newView: $t, LabelView: Ut },
    ts = {
      init: function (e) {
        xe.init(e),
          (es.LabelView.measuring = (function () {
            var e = xe.makeCanvas();
            return e.getContext("2d");
          })());
      },
      newView: es.newView,
      makeStyle: St.makeStyle,
    },
    ss = e(function (e) {
      function s(e, s) {
        return t({}, e, s);
          ...
          catHat: function (e, t, o) {
            return n.group([
              ...
              n.move(
                ...
                n.setProps(
                  n.group([
                    n.el("circle", { cx: 29.1, cy: -3.3, r: 3.4 }),
                    n.el("circle", { cx: 59.2, cy: -3.3, r: 3.4 }),
                    n.el("path", {
      ...
      var t = (e.exports = {
        ...
        makeIcons: function () {
          return [
            ...
            ss.setProps(
              ss.group([
                ss.el("circle", { opacity: 0.25, cx: 32, cy: 16, r: 4.5 }),
                ss.el("circle", { opacity: 0.5, cx: 32, cy: 12, r: 4.5 }),
                ss.el("circle", { opacity: 0.75, cx: 32, cy: 8, r: 4.5 }),
                ss.el("circle", { cx: 32, cy: 4, r: 4.5 }),
                ss.el("path", {
            ...
            ss.setProps(
              ss.group([
                ...
                ss.el("path", { fill: "red", d: "M4.2 27h31.9v.7H4.2z" }),
                ss.el("circle", {
                  fill: "#e0e0e0",
                  cx: "22.8",
                  cy: "18.2",
        ...
        makeStyle: function () {
          var e = ss.el("style");
          return e.appendChild(ss.cdata(t.cssContent)), e;
        },
  ...
  (io.prototype.isLabel = !0),
    ...
    (io.prototype.measure = function () {
      var e = this.value,
        t = "sb3-" + this.cls;
      this.el = ss.text(0, 13, e, { class: "sb3-label " + t });
  ...
  (ao.prototype.isIcon = !0),
    (ao.prototype.draw = function () {
      return ss.symbol("#sb3-" + this.name, {
        width: this.width,
        height: this.height,
      });
    }),
  ...
  (ro.prototype.isInput = !0),
    ...
    (ro.shapes = {
      string: ss.pillRect,
      number: ss.pillRect,
      "number-dropdown": ss.pillRect,
      color: ss.pillRect,
      dropdown: ss.roundRect,
      boolean: ss.pointedRect,
      stack: ss.stackRect,
      reporter: ss.pillRect,
    }),
    (ro.prototype.draw = function (e) {
      ...
      ss.setProps(a, {
        ...
        this.isColor
          ? ss.setProps(a, { fill: this.value })
          : "dropdown" === this.shape
          ? e.info.color &&
            ss.setProps(a, { fill: e.info.color, stroke: "rgba(0, 0, 0, 0.2)" })
          ...
          : "boolean" === this.shape &&
            ...
            e.info.color && ss.setProps(a, { fill: "rgba(0, 0, 0, 0.15)" }));
      var n = ss.group([a]);
      return (
        this.hasLabel && n.appendChild(s),
        this.hasArrow &&
          n.appendChild(
            ss.move(t - 24, 13, ss.symbol("#sb3-dropdownArrow", {}))
          ),
        n
      );
    });
  ...
  (co.prototype.isBlock = !0),
    ...
    (co.shapes = {
      stack: ss.stackRect,
      "c-block": ss.stackRect,
      "if-block": ss.stackRect,
      celse: ss.stackRect,
      cend: ss.stackRect,
      cap: ss.capRect,
      reporter: ss.pillRect,
      ...
      hat: ss.hatRect,
      cat: ss.catHat,
      "define-hat": ss.procHatRect,
      ring: ss.pillRect,
    }),
    (co.prototype.drawSelf = function (e, t, s) {
      if (1 < s.length)
        return ss.mouthRect(e, t, this.isFinal, s, {
          class: ["sb3-" + this.info.category].join(" "),
        });
      if ("outline" === this.info.shape)
        return ss.setProps(ss.stackRect(e, t), {
          class: [
    ...
    (co.prototype.draw = function () {
        ...
        if (((w = s[m]), (w.el = w.draw(this)), w.isScript && this.isCommand))
          ...
          (this.isCommand || this.isOutline) &&
            ...
            w.isIcon &&
              0 === m &&
              this.isCommand &&
              (u.height = E(u.height, w.height + 8)),
            (w.x = u.width),
            (u.width += w.width),
            (p = E(p, u.width)),
      ...
      for (var u, R = [], m = 0; m < A.length; m++) {
        ...
        for (var w, I = u.height, h = 0; h < u.children.length; h++) {
          ...
          var C = L + w.x;
          w.dx && (C += w.dx), R.push(ss.move(C, 0 | (u.y + c), w.el));
        }
      }
  ...
  (lo.prototype.isComment = !0),
    ...
    (lo.prototype.draw = function () {
      ...
      return (
        (this.width = this.label.width + 16),
        ss.group([
          ss.commentLine(this.hasBlock ? lo.lineLength : 0, 6),
          ss.commentRect(this.width, this.height, { class: "sb3-comment" }),
          ss.move(8, 4, e),
        ])
      );
    });
  ...
  (po.prototype.isGlow = !0),
    ...
    (po.prototype.drawSelf = function () {
      ...
      return ss.setProps(e, { class: "sb3-diff sb3-diff-ins" });
    }),
    ...
    (ho.prototype.draw = function (e) {
      ...
      for (var o = 0; o < this.blocks.length; o++) {
        var a = this.blocks[o],
          n = e ? 0 : 2,
          r = a.draw();
        t.push(ss.move(n, s, r)), (this.width = E(this.width, a.width));
        var c = a.diff;
        if ("-" === c) {
          var l = a.width,
            p = a.firstLine.height || a.height;
          t.push(ss.move(n, s + p / 2 + 1, ss.strikethroughLine(l))),
            (this.width = E(this.width, a.width));
        }
        s += a.height;
        var h = a.comment;
        if (h) {
          var d = a.firstLine,
            ...
            g = s - a.height + d.height / 2,
            f = h.draw();
          t.push(ss.move(u, g - h.height / 2, f)),
            (this.width = E(this.width, u + h.width));
        }
      }
      return (
        (this.height = s + 1),
        e || this.isFinal || (this.height += a.hasPuzzle ? 8 : 0),
        !e && a.isGlow && (this.height += 7),
        ss.group(t)
      );
    });
  var uo = function (e) {
  ...
  (uo.prototype.measure = function () {
    ...
    (uo.prototype.render = function () {
      ...
      for (var e, t = 0, s = 0, o = [], a = 0; a < this.scripts.length; a++)
        (e = this.scripts[a]),
          s && (s += 10),
          (e.y = s),
          o.push(ss.move(0, s, e.draw())),
          (s += e.height),
          a != this.scripts.length - 1 && (s += 36),
          (t = E(t, e.width + 4));
      (this.width = t), (this.height = s);
      var n = ss.newSVG(t, s);
      return (
        n.appendChild((this.defs = ss.withChildren(ss.el("defs"), oo()))),
        n.appendChild(ss.group(o)),
        (this.el = n),
        n
      );
    }),
    (uo.prototype.exportSVGString = function () {
      ...
      var e = so();
      this.defs.appendChild(e);
      var t = new ss.XMLSerializer().serializeToString(this.el);
      return this.defs.removeChild(e), t;
    }),
