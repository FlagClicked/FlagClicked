         ...
         <a :href="user.profile">
            ...
            <div class="contributor-info">
              ...
              <div class="contributor-items">
                <div v-for="name of user.contributions" :title="icons[name].description">
                  {{icons[name].symbol}}
                </div>
              </div>
            </div>
...
<script>
  export default {
    ...
    async asyncData({ $http }) {
      const contributors = await $http.$get('https://raw.githubusercontent.com/FlagClicked/Contributors/master/.all-contributorsrc')
