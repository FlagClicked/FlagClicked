...
app.put('/api/tutorial/new', auth.middleware('authenticated'), async (req, res) => {
...
app.put('/api/tutorial/featured', auth.middleware('admin'), async (req, res) => {
...
app.put('/api/auth/login', async (req, res) => {
  let resp = await fetch(`https://api.scratch.mit.edu/studios/29872706/comments`)
